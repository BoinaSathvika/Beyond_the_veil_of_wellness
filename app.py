...
def submit():
    ...
    if (prediction == 0):
       return render_template("output.html",result ="According to our study we feel sad to inform you that the animal is weak it requires immediate doctor consultation")
    else:
       return render_template("output.html",result = "You are health is in normal condition and you are good to go")
